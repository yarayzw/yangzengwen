...
(function(a) {
	a.fn.olvSlides = function(b) {
		a.fn.olvSlides.option = {
			...
			fadeEasing: "",
			play: 5000,
			autoPlay:false,//鑷姩鎾斁锛岄粯璁alse,涓嶆挱鏀�
			pause: 2000,
			hoverPause: false,
			isSelfthumb: false,
			selfPrev: null,
		...
		return this.each(function() {
			...
			if (b.thumb) {
				...
				//#Prev  #Next
				if (b.thumbPage) {
					g.append('<a href="javascript:void(0);" hidefocus="true" class="' + b.thumbPrev + '"><span>Up</span></a><a href="javascript:void(0);" hidefocus="true" class="' + b.thumbNext + '"><span>Down</span></a>')
				}
				if (b.thumbDirection === "Y") {
					D = C.outerHeight();
