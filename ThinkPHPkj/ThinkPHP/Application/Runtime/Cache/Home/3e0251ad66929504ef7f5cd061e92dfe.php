                    ...
                    <div id="profile_wrapper">
                        ...
                        <div id="timeline_wrapper">
                            <div id="cover">
                                ...
                                <div style="width:860px;height:350px;background:#ffffff;margin-top:30px;">
                                    <table>
                                        <tr align="center">
                                            <td width="80px" height="50px">状态</td><td width="80px">发件人</td><td width="440px">内容</td><td width="180px">时间</td><td width="80px">操作</td>
                                        </tr>

                                        <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr align="center">
                                                <td height="50px">
                                                    <?php if($vo["status"] == 1): ?>未读<?php endif; ?>
                                                    <?php if($vo["status"] == 2): ?>已读<?php endif; ?>
                                                </td>
                                                <td><?php echo ($vo["sendername"]); ?></td>
                                                <td><?php echo ($vo["content"]); ?></td>
                                                <td><?php echo ($vo["addtime"]); ?></td>
                                                <td><a onclick="delselect(this)" uid="<?php echo ($vo["id"]); ?>" href="javascript:void(0)">删除</a></td>
                                            </tr><?php endforeach; endif; ?>

                                    </table>
                                    <div class="pagelist"><?php echo ($page); ?></div>
                                </div>
                                <form action="/thinkphp/index.php/Home/Home/delemsg" id="f0" method="post" style="display:none;">
...
<script>
   function delselect(ob) {
       var uid = $(ob).attr('uid');
       $('#delselect').attr('value',uid);
       $('#f0').submit()
   }
</script>